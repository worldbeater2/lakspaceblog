    ...
    >
      ...
      <div className="hero-content  text-start text-neutral-content">
        ...
        <div className="max-w-5xl">
          ...
          <button className="btn file: text-white btn-outline px-9 text-start animate-pulse hover:animate-none hover:bg-neworange hover:border-neworange hover:text-black "    >
              Explore
            </button>
          </div>
